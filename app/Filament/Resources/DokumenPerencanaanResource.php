...
{
    protected static ?string $model = DokumenPerencanaanModel::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Dokumen Perencanaan';
    protected static ?string $pluralLabel = 'Daftar Dokumen Perencanaan';
