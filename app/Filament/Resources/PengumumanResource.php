...
{
    protected static ?string $model = PengumumanModel::class;

    protected static ?string $navigationLabel = 'Pengumuman'; // nama di sidebar
    protected static ?string $pluralLabel = 'Pengumuman'; // nama di judul halaman
