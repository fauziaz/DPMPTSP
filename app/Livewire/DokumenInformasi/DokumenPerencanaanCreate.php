...
class DokumenPerencanaanCreate extends Component
{
    use WithFileUploads;
    ...
    public $fileUrl;    // untuk link/path eksternal
    public $tag;
    ...
    public function save()
    {
        ...
        if ($this->file) {
            // jika upload file
            $path = $this->file->store('perencanaan', 'public');
        ...
        DokumenPerencanaanModel::create([
            'judul'     => $this->judul,
        ...
        session()->flash('message', 'Data evaluasi perencanan berhasil disimpan!');
    }

    public function render()
    {
        return view('livewire.dokumen-informasi.evaluasi-perencanaan-create');
    }
}
