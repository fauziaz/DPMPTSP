...
class SektoralCreate extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($this->file) {
            // jika upload file
            $path = $this->file->store('ikm', 'public');
        ...
        session()->flash('message', 'Data ikm berhasil disimpan!');
    }

    public function render()
    {
        return view('livewire.layanan-publik.sektoral-create');
    }
}
