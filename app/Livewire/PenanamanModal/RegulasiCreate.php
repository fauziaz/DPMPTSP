...
class RegulasiCreate extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        if ($this->file) {
            // jika upload file
            $path = $this->file->store('regulasi', 'public');
        ...
        session()->flash('message', 'Data regulasi berhasil disimpan!');
    }

    public function render()
    {
        return view('livewire.penanaman-modal.regulasi-create');
    }
}
