...
<div class="card p-4">
    ...
    <form wire:submit.prevent="save">
        ...
        <input type="file" wire:model="gambar" class="form-control mb-2">

        <label>Atau Masukkan URL Gambar:</label>
        <input type="url" wire:model="gambarUrl" placeholder="https://example.com/image.jpg" class="form-control mb-2">
