<div class="profil-pimpinan-page">
    ...
    <x-template.hero-section
        ...
        subtitle="Dokumen rencana kerja dan strategi pembangunan DPMPTSP Kota Tasikmalaya"
    />
                        ...
                        @if($perencanaans->count())
                            @foreach($perencanaans as $perencanaan)
                                <x-dokumen-informasi.dokumen-card 
                                    ...
                                    :downloads="$perencanaan->downloads"
                                    tanggal="{{ \Carbon\Carbon::parse($perencanaan->tanggal)->locale('id')->translatedFormat('l, d F Y') }}"
                                    :id="$perencanaan->id"
                                    :file_path="$perencanaan->file_path"
                                    :iconClass="$this->getIconClass($perencanaan->file_path)"
                                />
                            @endforeach
                        @else
