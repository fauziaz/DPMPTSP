                        ...
                        @if($produks->count())
                            @foreach($produks as $produk)
                                <x-dokumen-informasi.dokumen-card 
                                    ...
                                    label="Produk Hukum"
                                    :downloads="$produk->downloads"
                                    tanggal="{{ \Carbon\Carbon::parse($produk->tanggal)->locale('id')->translatedFormat('l, d F Y') }}"
                                    :id="$produk->id"
                                    :file_path="$produk->file_path"
                                    :iconClass="$this->getIconClass($produk->file_path)"
                                />
                            @endforeach
                        @else
