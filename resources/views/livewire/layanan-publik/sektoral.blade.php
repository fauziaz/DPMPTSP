                        ...
                        @if($sektorals->count())
                            @foreach($sektorals as $sektoral)
                                <x-dokumen-informasi.dokumen-card 
                                    :judul="$sektoral->judul"
                                    :deskripsi="$sektoral->deskripsi"
                                    label="Data Statistik Sektoral"
                                    :downloads="$sektoral->downloads"
                                    tanggal="{{ \Carbon\Carbon::parse($sektoral->tanggal)->locale('id')->translatedFormat('l, d F Y') }}"
                                    :id="$sektoral->id"
                                    :file_path="$sektoral->file_path"
                                    :iconClass="$this->getIconClass($sektoral->file_path)"
                                />
                            @endforeach
                        @else
