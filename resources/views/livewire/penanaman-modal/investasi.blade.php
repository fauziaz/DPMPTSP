            ...
            <div class="content-card">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-4">
                        <x-penanaman-modal.sidebar-kategori-tahun 
                            :tahuns="$tahuns" 
                        ...
                        @if($investasis->count())
                            @foreach($investasis as $investasi)
                                <x-dokumen-informasi.dokumen-card
                                    :judul="$investasi->judul"
                                    :deskripsi="$investasi->deskripsi"
                                    label="Investasi"
                                    :downloads="$investasi->downloads"
                                    :tanggal="$investasi->tanggal"
                                    :id="$investasi->id"
                                    :file_path="$investasi->file_path"
                                    :iconClass="'bi bi-file-earmark-pdf'"
                                    :kategori="ucfirst($investasi->kategori)"  {{-- bisa "Potensi", "Promosi", dll --}}
                                />
