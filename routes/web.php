...
// Penanaman Modal
// =======================
Route::get('/penanaman-modal/regulasi', Regulasi::class)->name('penanaman-modal.regulasi');
Route::get('/penanaman-modal/regulasi-create', RegulasiCreate::class)->name('penanaman-modal.regulasi-create');
